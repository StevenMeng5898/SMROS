...
pub(crate) const USER_FXFS_MAX_NODES: usize = 8192;
pub(crate) const USER_FXFS_MAX_DIRENTS: usize = 8192;
pub(crate) const USER_FXFS_MAX_FILE_BYTES: usize = 64 * 1024 * 1024;
