...
pub(crate) const USER_FXFS_MAX_NODES: usize = 512;
pub(crate) const USER_FXFS_MAX_DIRENTS: usize = 768;
pub(crate) const USER_FXFS_MAX_FILE_BYTES: usize = 4 * 1024 * 1024;
